    ...
    document.getElementById("save-account").onclick = async () => {
      try {
        ...
        (localStorage.getItem("edge_session")
          ? localStorage
          : sessionStorage
        ).setItem("edge_session", JSON.stringify(s));
...
window.addEventListener("edge-data-ready", initConfig);
