...
window.EdgeDB.load = function () {
  try {
    ...
    EdgeDB.users.forEach(u => { if (!u.permissoes) u.permissoes = { visualizar_cameras:true, usar_camera_dispositivo:true, gerenciar_cameras:u.cargo==='administrador', visualizar_alertas:true, visualizar_relatorios:true, gerenciar_usuarios:u.cargo==='administrador', gerenciar_permissoes:u.cargo==='administrador', acessar_configuracoes:true }; });
